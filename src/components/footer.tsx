        ...
        <Div className="w-full mx-auto laptop:w-11/12 desktop:w-10/12">
            <FlexRow className='phone:flex-col tablet:flex-row w-full items-center justify-between'>
                ...
                <FlexRow className='items-center phone:flex-col phone:w-full tablet:w-auto tablet:flex-row'>
                    <FlexRow className='items-center justify-around phone:w-full tablet:w-auto'>
                        <Link className="text-center phone:w-1/2 tablet:w-auto" href="https://zuitt.co/" target='_blank'>
                            <Image
                                src={Images.zuitt}
                                alt="C Logo"
                                className='rounded-full object-cover mx-4 p-2 tablet:bg-white text-center mx-auto'
                                width={120}
                                height={40}
                            />
                        </Link>
                        <Link className="text-center phone:w-1/2 tablet:w-auto" href="https://www.xtendly.com/" target='_blank'>
                            <Image
                                src={Images.xtendly}
                                alt="C Logo"
                                className='rounded-full object-cover mx-4 p-2 tablet:bg-white text-center mx-auto'
                    ...
                    <FlexRow className='items-center justify-around phone:w-full tablet:w-auto'>
                        ...
                        <Link className="text-center phone:w-1/2 tablet:w-auto" href="https://prosperna.com/" target='_blank'>
                            <Image
            ...
            <FlexRow className='phone:flex-col tablet:flex-row w-full items-start justify-start'>
                <FlexColumn className="phone:w-full tablet:w-2/5 phone:items-center tablet:items-start justify-start">
                    ...
                    <Spacer className="w-8 h-8" />
                    <Link className={`phone:text-center tablet:text-left ${(isDarkTheme ?? true) ? 'text-white' : 'text-dark-100'} my-1 hover:underline`} href="mailto:chuacharlesbon@gmail.com?cc=charlessbonnchua@gmail.com&subject=Client%20Inquiry" target="_top">
                        <Span className='mr-2'>
                            Email:
                        </Span>
                        chuacharlesbon@gmail.com
                    </Link>
                    <Link className={`phone:text-center tablet:text-left ${(isDarkTheme ?? true) ? 'text-white' : 'text-dark-100'} my-1 hover:underline`} href="https://gitlab.com/chuacharlesbon" target="_blank">
                        <Span className='mr-2'>
                            Gitlab:
                        </Span>
                        https://gitlab.com
                    </Link>
                    <Link className={`phone:text-center tablet:text-left ${(isDarkTheme ?? true) ? 'text-white' : 'text-dark-100'} my-1 hover:underline`} href="https://www.linkedin.com/in/charles-chua-12116122a/y" target="_blank">
                        <Span className='mr-2'>
                            LinkedIn:
                        </Span>
