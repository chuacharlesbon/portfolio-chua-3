...
import { Certificates } from "@/constants/assets";
import { useWindowSize } from '@/hooks/useWindowSize';

export const CertificateSlider: FC<any> = () => {
    const responsive = {
        mobile: {
    ...
    return (
        <Div className='w-full'>
            ...
            >
                <Div className='w-full h-500px laptop:h-600px desktop:h-700px' style={{
                    backgroundImage: `url(${Certificates.fullStack})`,
                    backgroundSize: 'contain',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat',
                }}>
                    <FlexRow className='hidden  phone:w-full tablet:w-4/5 h-full bg-gradient-to-r from-fullBlack justify-start items-center'>
                ...
                <Div className='w-full h-500px laptop:h-600px desktop:h-700px' style={{
                    backgroundImage: `url(${Certificates.aspnet})`,
                    backgroundSize: 'contain',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat',
                }}>
                ...
                <Div className='w-full h-500px laptop:h-600px desktop:h-700px' style={{
                    backgroundImage: `url(${Certificates.laravel})`,
                    backgroundSize: 'contain',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat',
                }}>
                ...
                <Div className='w-full h-500px laptop:h-600px desktop:h-700px' style={{
                    backgroundImage: `url(${Certificates.aws})`,
                    backgroundSize: 'contain',
                    backgroundPosition: 'center',
                    backgroundRepeat: 'no-repeat',
                }}>
